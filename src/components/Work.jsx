            ...
            >
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                <a
                  ...
                  className="text-lg font-semibold text-white group-hover:text-neutral-200 transition-colors"
                >
                  {project.title}
                  <ArrowUpRight size={16} className="inline-block ml-1 -mt-0.5 text-neutral-600 group-hover:text-neutral-400 transition-colors" />
                </a>
